                ...
                <div className='gh_content_area'>
                    <div className='gh_res_area'>
                        ...
                        <div className='gh_bt_area'>
                            ...
                            <button className='gh_search_bt2' disabled={gatList.length == 0 ? gatList.length == 0 : gatList.length % 6 == 0 ? page + 1 == gatList.length / 6 : page + 1 == Math.floor(gatList.length / 6 + 1)} 
                            onClick={() => {
                                setPage(page + 1)
                                change_newPage(page + 1, gatList);
                            }}>
